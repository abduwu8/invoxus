...
import { Star, Reply as LucideReply, Trash2, Wand2, Send, X, Plus, Inbox, MessageSquare, Bot, Sparkles, CheckSquare, KeyRound } from 'lucide-react'
      ...
      <div className="flex h-full">
        ...
        <aside className="w-64 border-r border-neutral-800 p-3 flex flex-col gap-4 bg-neutral-950/40">
          <div className="flex items-center gap-2 px-2 pt-1">
            <div className="size-6 rounded bg-blue-500/80 text-white flex items-center justify-center font-bold">
